...
<html>
<body>
	<div class="row" style="margin-left:150px;margin-right:150px;margin-top: 65px">
    ...
    <div class="col-sm-6 col-md-3">
        <a href="#" class="thumbnail">
            <img src="image/show3.png" onclick="showModal(3)"
                 alt="色斑图样例">
        </a>
        <div class="caption">
                <h3>色斑图样例</h3>
                <p>数据纯属虚构</p>
                <p>
                    <a href="javascript:void(0)" onclick="showModal(3)"  class="btn btn-primary" role="button">
                        查看
                    </a>
                </p>
         </div>
	...
	<div class="col-sm-6 col-md-3">
       <a href="#" class="thumbnail">
            <img src="image/show4.png" onclick="showModal(4)"
                 alt="色斑图样例">
        </a>
		 <div class="caption">
                <h3>缩略图标签</h3>
